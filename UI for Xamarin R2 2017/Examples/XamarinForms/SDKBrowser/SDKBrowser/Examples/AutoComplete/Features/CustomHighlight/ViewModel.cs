...
namespace SDKBrowser.Examples.AutoComplete.Features.CustomHighlight
{
    // >> autocomplete-features-custom-highlight-viewmodel
    ...
    public class ViewModel
    {
        public ViewModel()
        {
            this.Source = new List<BusinessObject>()
            {
                ...
                new BusinessObject("Harry Douglas", "busy32.png"),
