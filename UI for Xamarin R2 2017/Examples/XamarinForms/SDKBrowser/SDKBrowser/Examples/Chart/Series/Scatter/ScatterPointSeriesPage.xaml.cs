...
{
    public partial class ScatterPointSeriesPage
    {
        public ScatterPointSeriesPage()
        {
            InitializeComponent();

            var model = new MainViewModel();
            model.Data1 = MainViewModel.GetNumericData2(20, 30, 3, (i) => 60 * i + 450, (i) => 20 * (Math.Sin(0.13 * i)) + 6);
            model.Data2 = MainViewModel.GetNumericData2(20, 30, 3, (i) => 60 * i + 450, (i) => 20 * (Math.Sin(0.13 * i)) + 6, true);
			...
			chart.PaletteName = Telerik.XamarinForms.Chart.PaletteNames.LightSelected;
            ...
            var series1 = new ScatterPointSeries();
