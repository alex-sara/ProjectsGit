...
{
    public partial class ScatterSplineAreaSeriesPage
    {
        public ScatterSplineAreaSeriesPage()
        {
            InitializeComponent();
            ...
            var series = new Telerik.XamarinForms.Chart.ScatterSplineAreaSeries();

            series.ItemsSource = model.Data1;

            series.XValueBinding = new Telerik.XamarinForms.Chart.PropertyNameDataPointBinding
            {
                PropertyName = "XData"
            };

            series.YValueBinding = new Telerik.XamarinForms.Chart.PropertyNameDataPointBinding
            {
                PropertyName = "YData"
            };
